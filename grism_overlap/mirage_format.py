...
def mirage_format(filename, name_fragment):
    """
    Convert the ouput file from niriss_magnitude_converter.py into mirage-style star list files
...
if __name__ == "__main__":
    mirage_format(sys.argv[-2], sys.argv[-1])
